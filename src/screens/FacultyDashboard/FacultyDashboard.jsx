...
import { View, ScrollView, StyleSheet, TouchableOpacity, TouchableHighlight,Text, Modal } from "react-native";
...
const FacultyDashboard = ({navigation}) => {
  ...
  const [menuActive, setMenuActive] = useState(false); // New state for tracking menu active status
